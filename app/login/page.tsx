...
import { 
  ...
  ArrowRight, Loader2, AlertTriangle, ShieldCheck, 
  Zap, Home, Activity
} from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // 10-second timeout in case Supabase is paused/slow
  ...
  return (
    <div className="min-h-screen bg-[#07090D] flex items-center justify-center p-6 relative overflow-hidden selection:bg-accent-blue selection:text-white">
      ...
      <div className="w-full max-w-[440px] relative z-10 animate-fade-in text-center mx-auto">
        {/* Logo */}
        <Link href="/" className="inline-flex items-center gap-3 mb-8 hover:scale-105 transition-transform group/logo">
        ...
        <div className="relative bg-[#0F1117]/80 border border-white/10 rounded-[32px] p-1 shadow-[0_0_80px_-20px_rgba(0,0,0,0.8)] overflow-hidden">
          ...
          <div className="p-6 sm:p-8 relative z-10 text-left">
             ...
             <div className="flex items-center justify-between mb-6">
                <div>
                   <h1 className="font-display font-900 text-2xl text-white tracking-tight mb-2 italic">Login</h1>
                ...
                <div className="flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-full">
                   ...
                   <span className="text-accent-green text-[9px] font-900 uppercase">Secure</span>
                </div>
             </div>
               ...
               <div className="space-y-4">
                 ...
                 <div className="group/input">
                   <div className="flex items-center justify-between mb-2.5 ml-1">
                     <label className="text-white/30 text-[10px] font-900 uppercase tracking-[0.2em]">Password</label>
                     <Link href="/forgot-password" className="text-accent-blue hover:text-white text-[9px] font-900 uppercase tracking-widest transition-colors tracking-tighter">
                        Forgot Password?
                     </Link>
                   </div>
                   <div className="relative">
               ...
               >
                 ...
                 {loading ? (
                   <>
                     ...
                     <span className="uppercase tracking-widest leading-none">Logging in...</span>
                   </>
                 ) : (
                   <>
                     <span className="uppercase tracking-widest leading-none">Sign In</span>
             ...
             <div className="pt-6 border-t border-white/5 flex flex-col items-center gap-4 text-center">
                ...
                <div className="flex items-center gap-1.5 text-white/30 text-[10px] font-900 uppercase tracking-widest">
                   <span>New user?</span>
                   <Link href="/signup" className="text-accent-blue hover:text-white transition-colors underline underline-offset-4 decoration-accent-blue/30">
                      Create an account
                   </Link>
                </div>
             </div>
